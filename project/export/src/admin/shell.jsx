...
function Sidebar({active}){
  const groups = [
    {l:'Overview', items:[
      ...
      {id:'analytics', label:'Analytics',     ic:'chart', to:'#/analytics'},
    ]},
    {l:'Operations', items:[
    ...
    <aside style={{
      ...
      <div style={{marginTop:'auto', padding:'14px', background:'rgba(255,255,255,.04)', border:'1px solid rgba(255,255,255,.06)', borderRadius:12}}>
        <div style={{display:'flex', alignItems:'center', gap:10}}>
          ...
          <button style={{background:'none', border:0, color:'rgba(255,255,255,.6)', cursor:'pointer'}}><Icon name="logout" size={16}/></button>
        </div>
      </div>
    </aside>
  );
