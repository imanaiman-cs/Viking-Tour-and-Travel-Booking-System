...
function UserPopover(){
  ...
  return (
    <div style={{
      ...
      {items.map((it,i)=>(
        <a key={i} href={it.to} onClick={(e)=>{e.preventDefault(); nav(it.to);}} style={{
          display:'flex', alignItems:'center', gap:12, padding:'9px 10px',
          width:'100%', background:'transparent', border:'none', borderRadius:8,
          cursor:'pointer', textAlign:'left', color:'var(--ink-700)', textDecoration:'none'
        }}
      ...
      <div style={{borderTop:'1px solid rgba(255,255,255,.08)'}}>
        <div style={{
          ...
          <div style={{display:'flex', gap:24}}>
            ...
            <a href="#">Sitemap</a>
            <a href="auth.html#admin" style={{display:'inline-flex', alignItems:'center', gap:6, color:'rgba(255,255,255,.7)'}}>
              <span style={{width:5, height:5, borderRadius:5, background:'var(--coral)'}}/>
              Staff sign-in
            </a>
          </div>
